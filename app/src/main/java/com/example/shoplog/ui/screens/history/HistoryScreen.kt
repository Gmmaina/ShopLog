...
fun HistoryScreen(
    ...
    val lists by viewModel.savedLists.collectAsState()
    ...
    Scaffold(
        ...
        Column(
            ...
            OutlinedTextField(
                ...
                placeholder = { Text("Search shopping by title or store...") },
            ...
            if (lists.isEmpty()) {
                ...
                Box(
                    ...
                    Column(horizontalAlignment = Alignment.CenterHorizontally) {
                        ...
                        Text(
                            text = "Your shopping history will appear here.",
                ...
                LazyColumn(
                    ...
                    items(lists, key = { it.list.id }) { itemWithList ->
